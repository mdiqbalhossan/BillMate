...
@section('content')
                    ...
                    <div class="breadcrumb-main m-0 breadcrumb-main--table justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            <div class="d-flex align-items-center ticket__title justify-content-center me-md-25 mb-md-0 mb-20">
                                <h4 class="text-capitalize fw-500 breadcrumb-title">Taxes List</h4>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless data-table" width="100%">
                                ...
                                <tr class="userDatatable-header">
                                    ...
                                    <th>
                                        <span class="userDatatable-title">Is Default</span>
                                    </th>
                                    <th>
    ...
    @include('admin.taxes.taxAddEditModal')
@endsection
    ...
    <script !src="">
        $(document).ready(function () {
            ...
            $('#addBtn').click(function () {
                ...
                $('.modal-title').html("Add New Tax");
            });

            /*Click Edit Button*/
            $('body').on('click', '.editBtn', function () {
                var tax_id = $(this).data('id');
                $.get("{{ route('admin.tax.index') }}" +'/' + tax_id +'/edit', function (data) {
                    console.log(data);
                    ...
                    $('#name').val(data.name);
                    $('#rate').val(data.rate);
                    //radio button yes cheked if is_default is 1
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('admin.tax.store') }}"+'/'+tax_id,
                                success: function (data) {
                                    table.draw();
