...
@section('content')
                    ...
                    <div class="breadcrumb-main m-0 breadcrumb-main--table justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            <div class="d-flex align-items-center ticket__title justify-content-center me-md-25 mb-md-0 mb-20">
                                <h4 class="text-capitalize fw-500 breadcrumb-title">Expenses Purpose List</h4>
                            </div>
                        </div>
    ...
    @include('admin.expenses.purposeAddEditModal')
@endsection
    ...
    <script !src="">
        $(document).ready(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.expense-purpose.index') }}",
                columns: [
            ...
            $('#addBtn').click(function () {
                ...
                $('.modal-title').html("Add New Purpose");
            });

            /*Click Edit Button*/
            $('body').on('click', '.editBtn', function () {
                var purpose_id = $(this).data('id');
                $.get("{{ route('admin.expense-purpose.index') }}" +'/' + purpose_id +'/edit', function (data) {
                    console.log(data);
                    $('.modal-title').html("Edit Purpose");
            ...
            $('#submitBtn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.expense-purpose.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        ...
                        table.draw();
                        toastr.success("Expense Purpose Saved Successfully!!");
                    },
                    error: function (data) {
                        if (data.status == 422) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('admin.expense-purpose.store') }}"+'/'+tax_id,
                                success: function (data) {
                                    table.draw();
